...
library Address{
 ...
 contract ChibaNeko is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x50bF0eAf6149F6029469d0F9Ac874e22F94b670a;
    address public developmentWallet = 0x0c89ceC41c40f3cA9e20673eE65Ed52E544c9e99;
    address public LPWallet = 0xF02725a54c1840A94531ba55cBa346f36590ca62;
    address public TeamWallet = 0x335eccD2e9E867c134FcC5032364c33d1e718d04;
    // address public TeamWallet = 0xEdc17B914aA1168A7F6BE8CE73E774C0C10ac122;

    string private constant _name = "My Chiba Neko";
    string private constant _symbol = "MYCHIBA";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isSell) private {
        ...
        if (s.tTeam > 0)
            _transfer(sender, TeamWallet, s.tTeam); // Transfer tokens to the team wallet
